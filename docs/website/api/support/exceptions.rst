...
.. cpp:class:: unreachable_error : public exception
   ...
   .. cpp:function:: unreachable_error(const char *filename, size_t line) 
      ...
      :param filename: the name of the file of the :c:macro:`black_unreachable` 
         call.
...
.. cpp:class:: assert_error : public exception
   ...
   .. cpp:function:: assert_error( \
      ...
      :param expression: a string representation of the asserted expression of 
         the failed :c:macro:`black_assert` call.

   .. cpp:function:: const char* filename() const

      :returns: the name of the file of the failed :c:macro:`black_assert` call.
...
.. cpp:class:: assume_error : public assert_error
   ...
   .. cpp:function:: assume_error( \
      ...
      :param loc: :cpp:type:`source_location` of the failed `black_assume` call.
